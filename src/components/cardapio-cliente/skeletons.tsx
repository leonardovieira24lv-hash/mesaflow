  ...
  return (
    <div className="menu-dark min-h-dvh bg-background flex flex-col">
      ...
      <main className="flex flex-1 flex-col gap-6 px-4 py-6">
        ...
        <div className="flex items-center justify-between rounded-lg border border-border bg-surface p-4 elevation-card">
        ...
        <div className="flex flex-col gap-2">
          ...
          {Array.from({ length: 3 }).map((_, i) => (
            <div key={i} className="flex items-center justify-between rounded-lg border border-border bg-surface p-3 elevation-card">
